...
class RekapBidang1Export implements FromView
{
    ...
    public function view(): View
    {
        ...
        SUM(poin41) AS sum41, SUM(poin42) AS sum42, SUM(poin43) AS sum43, SUM(poin44) AS sum44, SUM(poin45) AS sum45, SUM(poin46) AS sum46, SUM(poin47) AS sum47, SUM(poin48) AS sum48, SUM(poin41 + poin42 + poin43 + poin44 + poin45 + poin46 + poin47 + poin48) AS jum4
            FROM `data_laporan`  
